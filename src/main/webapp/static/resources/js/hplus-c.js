				...
				function() {
					...
					$('.check-link').click(
							function() {
								...
								button.toggleClass('fa-check-square')
					...
					$('#side-menu>li').click(
							function() {
								...
								$(this).closest(".navbar-static-side").find(
										"li").removeClass("active");
								$(this).addClass("active");
							});
					/*
					 * $('#side-menu>li li a').click(function () { if
...
/*
 * $(window).bind("load resize", function () { if ($(this).width() < 769) {
 * $('body').addClass('mini-navbar'); $('.navbar-static-side').fadeIn(); } });
 */
